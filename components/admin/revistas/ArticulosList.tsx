                ...
                {removePending?.publicacionId === art.publicacion_id && (
                  <div className="mt-3 pt-3 border-t border-[--color-border]">
                    ...
                    <div className="flex items-start gap-2">
                      <span className="text-xs text-[--color-text-muted] mt-2 shrink-0 leading-none">
                        Aceptada y después cancelada por:
                      </span>
                      <textarea
                        className="flex-1 rounded-[--radius-sm] border border-[--color-border] bg-[--color-surface-muted] px-3 py-2 text-sm text-[--color-text] resize-none focus:outline-none focus:ring-2 focus:ring-[--color-primary]"
                        rows={2}
                        maxLength={200}
